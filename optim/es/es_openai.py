...
class ESOpenAI(BaseOptim):
    def __init__(self, config):
        ...
        self.agent_ids = None
        self.mu_model = None
        self.mu_model_flatten_params = None  # Ya added
        self.optimizer = None
    ...
    def next_population(self, assemble, results, g):
        ...
        self.mu_model_flatten_params.grad = torch.tensor(grad_param_list, dtype=torch.float64)  # set grad to corresponding para
        self.optimizer.step()
